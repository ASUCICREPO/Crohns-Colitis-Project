...
export const CookieUtils = {
  ...
  /**
   * Get or create session ID - persists across pages in same domain
   */
  getSessionId() {
    ...
    console.log('🍪 DEBUG - Cross-page persistence enabled');
    ...
    if (!sessionId) {
      ...
      this.setCookie('chatSessionId', sessionId); // Session cookie persists across pages
      console.log('🍪 DEBUG - Set cross-page session cookie with sessionId:', sessionId);
      ...
      console.log('🍪 DEBUG - Session will persist when navigating between pages');
    }
  ...
  setCookie(name, value, days = null) {
    ...
    console.log('🍪 DEBUG - Cookie will persist across page navigation');
  ...
  removeCookie(name) {
    ...
    console.log('🍪 DEBUG - Cookie removed');
  },

  /**
   * Clear session - removes session cookie
   */
  clearSession() {
    console.log('🍪 DEBUG - Clearing session');
    this.removeCookie('chatSessionId');
